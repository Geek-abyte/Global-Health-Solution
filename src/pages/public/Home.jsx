...
const Home = () => {
  ...
  useEffect(() => {
    const mediaQuery = window.matchMedia('(max-width: 768px)'); // Define your own mobile breakpoint
    ...
    handleMediaQueryChange(mediaQuery); // Initial check on component mount
