...
const ImageCard = ({children, image, className }) => {
  return (
    <div className={`h-[300px] w-[230px] b-1 flex flex-col rounded-[22px] p-5 overflow-hidden border-[2px] border-primary-6 ${className}`}>
